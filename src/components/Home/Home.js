        ...
        <Container className="home">
          ...
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              Ever since young I have loved programming, but back in my home couuntry
              ...
              <i>
                <b className="blue"> Javascript C# and LabVIEW. </b>
              </i>
              <br />
              <br />
              ...
              <br />
              <br />
              I also love doing web development
              ...
              &nbsp; like
              <i>
                <b className="blue"> React.js ans Express.js</b>
              </i>
            </p>
          </Col>
        </Row>
